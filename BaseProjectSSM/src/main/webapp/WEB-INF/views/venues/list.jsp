...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>球场编号:</label><input id="search-name" class="wu-text" style="width:100px">
            <label>所属球馆:</label>
...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                <td align="right">全场预约价格:</td>
                <td><textarea id="add-allprice" name="allprice" class="wu-textarea" style="width:260px"></textarea></td>
            </tr>
            <tr>
                <td align="right">最大人数:</td>
                <td><textarea id="add-max" name="max" class="wu-textarea" style="width:260px"></textarea></td>
            </tr>
        </table>
    </form>
</div>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td align="right">全场预约价格:</td>
                <td><textarea id="edit-allprice" name="allprice" class="wu-textarea" style="width:260px"></textarea></td>
            </tr>
            <tr>
                <td align="right">最大人数:</td>
                <td><textarea id="edit-max" name="max" class="wu-textarea" style="width:260px"></textarea></td>
            </tr>
...
<script type="text/javascript">
	...
	*/
	function openAdd(){
		$('#add-form').form('clear');
        $('#edit-roleId').combobox('setValue','0');
		$('#add-dialog').dialog({
			closed: false,
			modal:true,
            title: "添加用户信息",
	...
	*/
	function openEdit(){
		...
		$('#edit-dialog').dialog({
            ...
            onBeforeOpen:function(){
            	$("#edit-id").val(item.id);
            	$("#edit-username").val(item.venuesname);
            	$("#edit-roleId").combobox('setValue',item.stadiumid);
                $("#edit-price").val(item.price);
                $("#edit-allprice").val(item.allprice);
                $("#edit-max").val(item.max);
            }
        });
	}	
	...
	$("#search-btn").click(function(){
		...
		var option = {venuesname:$("#search-name").val()};
		if(stadiumId != -1){
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'venuesname',title:'球场编号',width:100,sortable:true},
            ...
            { field:'allprice',title:'全场价格',width:100},
            { field:'max',title:'最大人数',width:100}
		]]
	});
</script>